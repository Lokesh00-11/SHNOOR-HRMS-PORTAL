...
from .views import (
    LoginView, AdminStatsView, CompanyListView, CompanyDetailView, 
    ...
    EmployeeReportView,
    LetterHeadView, LetterHeadDetailView, 
    UserProfileView, AdminSettingsView,
    EmployeeStatsView, 
    CalendarDataView, AssetView, EmployeeAppreciationView,
    ManagerAttendanceView, 
    ManagerPerformanceView, ManagerNotificationView, ManagerExpenseView,
    EmployeeAttendanceView, 
    EmployeeClockInView, EmployeeClockOutView, 
    EmployeeAttendanceTodayView,
    TeamLeaderAttendanceView,
    ...
    OrgChartView, OrgChartDetailView, 
    NotificationView, 
